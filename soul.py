...
FORWARD_CHANNEL_ID = -1002205764066
CHANNEL_ID = -1002205764066
error_channel_id = -5962383405
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/souravowner*", parse_mode='Markdown')
